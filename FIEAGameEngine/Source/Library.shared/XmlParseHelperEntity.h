...
namespace FieaGameEngine
{
	...
	public:
		...
		XmlParseHelperEntity(const XmlParseHelperEntity& otherHelper) = delete;

		/**Assignment for the helper that is deleted. */
		XmlParseHelperEntity& operator=(const XmlParseHelperEntity& otherHelper) = delete;
