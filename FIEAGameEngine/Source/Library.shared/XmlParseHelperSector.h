...
namespace FieaGameEngine
{
	...
	public:
		...
		XmlParseHelperSector();

		/**Copy constructor for the helper that is deleted. */
		XmlParseHelperSector(const XmlParseHelperSector& otherHelper) = delete;

		/**Assignment for the helper that is deleted. */
		XmlParseHelperSector& operator=(const XmlParseHelperSector& otherHelper) = delete;
