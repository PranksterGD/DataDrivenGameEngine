...
namespace FieaGameEngine
{
	...
	public:
		...
		XmlParseHelperMatrix(const XmlParseHelperMatrix& otherHelper) = delete;

		/**Assignment for the helper that is deleted. */
		XmlParseHelperMatrix& operator=(const XmlParseHelperMatrix& otherHelper) = delete;
	...
	private:
		...
		static const std::string sMatrixTag;
	};
}
