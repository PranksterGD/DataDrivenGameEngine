...
namespace FieaGameEngine
{
	...
	public:
		...
		XmlParseHelperReaction(const XmlParseHelperReaction& otherHelper) = delete;

		/**Assignment for the helper that is deleted. */
		XmlParseHelperReaction& operator=(const XmlParseHelperReaction& otherHelper) = delete;
		...
		* @return- A pointer pointing to the new instance of the helper.*/
		...
		virtual ~XmlParseHelperReaction();
