...
namespace FieaGameEngine
{
	...
	public:
		...
		XmlParseHelperVector(const XmlParseHelperVector& otherHelper) = delete;

		/**Assignment for the helper that is deleted. */
		XmlParseHelperVector& operator=(const XmlParseHelperVector& otherHelper) = delete;
	...
	private:
		...
		static const std::string sVectorTag;
	};
}
